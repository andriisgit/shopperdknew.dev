...
class Queldorei_ShopperSettings_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	public function checkIfConfSwatchesEnabled()
	{
		if(Mage::helper('core')->isModuleEnabled('Mage_ConfigurableSwatches') && Mage::helper('core')->isModuleOutputEnabled('Mage_ConfigurableSwatches') && Mage::getStoreConfig('configswatches/general/enabled'))
		{
			return true;
		}
		return false;
