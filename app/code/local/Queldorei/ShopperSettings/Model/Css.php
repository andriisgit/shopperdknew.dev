...
class Queldorei_ShopperSettings_Model_Css extends Mage_Core_Model_Abstract
{
	/**
	 * css file name
	 * @var string
	...
	public function _construct()
	{
		...
		$this->_css_path = Mage::getBaseDir() . '/skin/frontend/shopper/default/css/';
		$this->_css_template_path = Mage::getBaseDir() . '/app/code/local/Queldorei/ShopperSettings/css/css.php';
	}
