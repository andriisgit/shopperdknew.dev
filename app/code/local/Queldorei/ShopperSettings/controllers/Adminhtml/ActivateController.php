 ...
 * @copyright Copyright (C) 2010 - 2015 Queldorei
 */
	...
	public function activateAction()
    {
        ...
        try {
	        foreach ($stores as $store) {
                ...
                //design > footer
                Mage::getConfig()->saveConfig('design/footer/copyright', 'Shopper &copy; 2015 <a href="http://queldorei.com" >Premium Magento Themes</a> by Queldorei', $scope, $store);
