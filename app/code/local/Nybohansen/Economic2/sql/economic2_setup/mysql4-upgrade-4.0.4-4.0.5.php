...
*/
	...
	define('ECONOMIC_TABLE_NAME3', 'economic2_order_status');
    ...
    $installer->run("ALTER TABLE  {$this->getTable(ECONOMIC_TABLE_NAME3)} ADD  `integrity_check` BOOLEAN NOT NULL DEFAULT  '1'");
