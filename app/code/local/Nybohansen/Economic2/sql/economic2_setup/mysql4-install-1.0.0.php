...
*/	 
	...
	define('ECONOMIC_TABLE_NAME', 'economic2_order_status');
	
	$installer = $this;
	$installer->startSetup();
 
  	$installer->run("DROP TABLE IF EXISTS {$this->getTable(ECONOMIC_TABLE_NAME)};
    				 CREATE TABLE {$this->getTable(ECONOMIC_TABLE_NAME)} (
