...
class Nybohansen_Economic2_Block_EconomicFieldsEditable extends Mage_Core_Block_Html_Select{
     ...
     */
	protected function _getEconomicFieldsEditable(){
    	if(is_null($this->_fields)){
        	$this->_fields = array();
        	$this->_fields['Name'] = Mage::helper('economic2')->__('Name');
        	$this->_fields['BarCode'] = Mage::helper('economic2')->__('Barcode');
        	$this->_fields['CostPrice'] = Mage::helper('economic2')->__('Cost Price (Only applicable if stock module disabled in e-conomic)');
...
//         	$this->_fields['IsAccessible'] = Mage::helper('economic2')->__('Accessible');
        	$this->_fields['SalesPrice'] = Mage::helper('economic2')->__('Sales price');
         	$this->_fields['RecommendedPrice'] = Mage::helper('economic2')->__('Recomended price (only applicable if e-conomic stock module is active)');
//         	$this->_fields['Available'] = Mage::helper('economic2')->__('Items available for sale');
    ...
    {
    	if (!$this->getOptions()) {
            foreach ($this->_getEconomicFieldsEditable() as $key => $label) {
