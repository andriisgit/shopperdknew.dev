...
jQuery(function($){
    ...
    function reload(url) {
        ...
        $('.col-main-wrap').first().load(url, function(data){
			if(typeof Catalog != 'undefined' && Catalog && typeof Catalog.Map != 'undefined' && Catalog.Map)
			{
				Catalog.Map.pricesliderEnabled = true;
