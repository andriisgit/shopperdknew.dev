...
Catalog.Map = {
    ...
    showHelp: function(event) {
        ...
        if (this != Catalog.Map && Catalog.Map.active != this.link) {
            ...
            if (typeof this.cartLink != 'undefined') {
				cartButton.setAttribute("data-url", this.cartLink);
    ...
    bindProductForm: function(){		
        if (('undefined' != typeof productAddToCartFormProductView) && productAddToCartFormProductView && !Catalog.Map.pricesliderEnabled) {			
            ...
            return false;
        } else if ('undefined' == typeof productAddToCartFormProductView || Catalog.Map.pricesliderEnabled) {			
            productAddToCartForm = new VarienForm('product_addtocart_form_from_popup');
			Catalog.Map.pricesliderEnabled = false;
        }

        productAddToCartForm.submit = function(button, url) {			
			if($(button).hasAttribute('queldorei_ajax_map'))
			{
